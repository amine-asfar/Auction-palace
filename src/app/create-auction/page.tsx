    ...
    if (formData.min_bid_increment) {
      ...
      if (minBidIncrement >= price) {
        toast({
          title: "Erreur",
          description:
            "L'incrément minimum de mise ne peut pas être supérieur ou égal au prix de départ",
          variant: "destructive",
        });
        return;
      }
    ...
    try {
      ...
      const productData = {
        ...
        min_bid_increment: formData.min_bid_increment
          ? parseFloat(formData.min_bid_increment)
          : undefined,
      };
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Montant minimum pour chaque nouvelle enchère. Si non spécifié,
              sera calculé automatiquement (10% du prix de départ).
            </p>
          </div>
