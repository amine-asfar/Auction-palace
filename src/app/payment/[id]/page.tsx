...
export default function PaymentPage() {
  ...
  const calculateCosts = () => {
    ...
    const deliveryFee = deliveryMethod === "delivery" ? 15.99 : 0;
            ...
            <Card className="p-8 text-center">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 text-left">
                ...
                <ul className="text-sm text-green-700 space-y-1">
                  ...
                  <li>
                    • Vous serez contacté pour organiser la{" "}
              ...
              <Card className="p-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500">Prix final</div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="p-6">
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl p-4">
                  ...
                  <p className="text-sm text-indigo-700">
                    Vos données bancaires sont protégées par le chiffrement SSL
                    de niveau bancaire. Stripe est utilisé par des millions
